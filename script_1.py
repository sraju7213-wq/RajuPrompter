# Create working JavaScript file (app.js) with all functionality
working_js = '''// AI Prompt Generator v2.0 - Working Version for Netlify
...
# Save working JavaScript
with open('app.js', 'w', encoding='utf-8') as f:
    f.write(working_js)

print("✅ Working JavaScript file created: app.js")